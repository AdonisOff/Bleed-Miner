...
def intro():
    ...
    m=('| $$  \ $$| $$| $$_____/| $$_____/| $$  | $$      | $$\  $ | $$| $$| $$  | $$| $$_____/| $$      ')
    n=('| $$$$$$$/| $$|  $$$$$$$|  $$$$$$$|  $$$$$$$      | $$ \/  | $$| $$| $$  | $$|  $$$$$$$| $$      ')
    p=('|_______/ |__/ \_______/ \_______/ \_______/      |__/     |__/|__/|__/  |__/ \_______/|__/      ')
    t = Terminal()
    global current
    current = -1
    while current < 107:
...
| $$  \ $$| $$| $$_____/| $$_____/| $$  | $$      | $$\  $ | $$| $$| $$  | $$| $$_____/| $$      
| $$$$$$$/| $$|  $$$$$$$|  $$$$$$$|  $$$$$$$      | $$ \/  | $$| $$| $$  | $$|  $$$$$$$| $$      
|_______/ |__/ \_______/ \_______/ \_______/      |__/     |__/|__/|__/  |__/ \_______/|__/                                                                                                       
        ...
        while i <= 1:
            ...
            if int(amount.value) >= int(amounttrigger.value):
                ...
                if (webhookurl != "null"):
                    ...
                    embed = DiscordEmbed(title="BLEED Miner | SUMMARY", color="8fce00")
                    embed.set_timestamp()
            ...
            try:
                ...
                if bal > 2000000000000000 or balp > 0 or balb > 0:
                        ...
                        if (webhookurl != "null"):
                            ...
                            embed = DiscordEmbed(title="Bleed Miner | NEW HIT", color="8fce00")
                            embed.set_timestamp()
...
def NUpdate(chk,hits,bdhits):
    ...
    while x < 1:
        if hits.value >= 1:
            sys.stdout.write("\x1b]2;Bleed Miner v1.4.0 | MINING...GOT A HIT! | ERRS: %s - HITS: %s - BDHITS: %s |\x07"%(chk.value, hits.value, bdhits.value))
        else:
            sys.stdout.write("\x1b]2;Bleed Miner v1.4.0 | MINING... | ERRS: %s - HITS: %s - BDHITS: %s |\x07"%(chk.value, hits.value, bdhits.value))
        time.sleep(0.02)
...
if __name__=="__main__":
    #try:
        ...
        print("v1.4.0")
        intro()
        sys.stdout.write("\x1b]2;Bleed Miner v1.4.0 | WAITING FOR INPUT | ERRS: 0 - HITS: 0 - BDHITS: 0 |\x07")
        print('\n')
            ...
            if int(intensity) >= 1 and int(intensity) <= 100:
                ...
                if w3.isConnected():
                    ...
                    if __name__=="__main__":
                        ...
                        if(webhookurl != "null"):
                            webhook = DiscordWebhook(url=webhookurl, rate_limit_retry=True)
                            embed = DiscordEmbed(title="Bleed Miner | MINING...", description="Miner started!", color=0x00ff00)
